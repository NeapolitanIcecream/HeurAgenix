...
def parse_arguments():
    ...
    parser.add_argument("-ed", "--evolution_dir", dest="evolution_dir", type=str, default="evolution_data", help="Directory containing the training dataset used for heuristic evolution. Default is evolution_data.")
    parser.add_argument("-vd", "--validation_dir", dest="validation_dir", type=str, default=None, help="Directory containing the validation dataset used to evaluate heuristic performance. Default is validation_data (same as evolution_dir if not set).")
    ...
    parser.add_argument("-pt", "--perturbation_time", type=float, default=100, help="Maximum number of perturbation cycles performed per evolution round.Default is 100.")
    ...
    parser.add_argument("-f", "--filter_num", type=int, default=1, help="Number of top-performing heuristics to retain after each validation phase. Default is 1.")
